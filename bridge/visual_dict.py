...
- 角色 appearance_lock 和 costume 必须符合角色年龄、身份、气质、剧情关系和时代背景，不要写成随机人设模板。
- 场景 space_lock 和 lighting 必须符合剧情发生地点的空间逻辑、建筑体系、陈设语言和光影基调，只写可画出的环境细节。
- 物件 appearance_lock 必须符合角色会使用的年代、材质、磨损和叙事功能，不要添加脱离剧本的装饰。
...
- 角色 costume：只写服装本体的可画细节：上装、内搭、下装、鞋履、配饰、颜色、面料、版型、纹理、磨损、年代特征；不要写人物动作、手持物、剧情含义、气质评价或"适合某角色"这类判断句。**必须点明服装所属年代/款式年代**(如"九十年代末蓝白运动校服")。
