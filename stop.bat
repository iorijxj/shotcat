...
for %%T in ("shotcat-backend-test" "shotcat-web-test" "shotcat-backend-run" "shotcat-web-run" "shotcat-celery-run" "shotcat-celery-test" "shotcat-caddy" "shotcat-wsl-keepalive" "shotcat-pipeline") do (
